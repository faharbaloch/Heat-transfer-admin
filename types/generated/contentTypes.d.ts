...
export interface ApiHomecalltoactionHomecalltoaction
  extends Schema.CollectionType {
  collectionName: 'homecalltoactions';
  info: {
    singularName: 'homecalltoaction';
    pluralName: 'homecalltoactions';
    displayName: 'homecalltoaction';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::homecalltoaction.homecalltoaction',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
